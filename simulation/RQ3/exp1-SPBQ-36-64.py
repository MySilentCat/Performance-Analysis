...
for i in range(0, 1):
    ...
    file_name = path + "/tmp_result/" + "36-64-SPBQ-s-"
    # print(file_name)
    ...
    file_name = path + "/tmp_result/" + "36-64-SPBQ-sc-"
    # print(file_name)
    AEU, ASR, TPS, ACU, last_time, AEU_dict = run(simulate_dict, exp_path, people_arr, actor_prob, business_prob, path_prob, actor_business, file_name)
    ...
    file_name = path + "/tmp_result/" + "36-64-SPBQ-a-"
    # print(file_name)
    AEU, ASR, TPS, ACU, last_time, AEU_dict = run(simulate_dict, exp_path, people_arr, actor_prob, business_prob, path_prob, actor_business, file_name)
    ...
    file_name = path + "/tmp_result/" + "36-64-SPBQ-ac-"
    # print(file_name)
    AEU, ASR, TPS, ACU, last_time, AEU_dict = run(simulate_dict, exp_path, people_arr, actor_prob, business_prob, path_prob, actor_business, file_name)
...
with open(path + "/result/exp1-SPBQ-36-64.txt", "w") as f:
