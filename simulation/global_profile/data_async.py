business_async = {
    "business": {
        "Add Book": {
            ...
            "path0": [
                # (发送者，接收者，消息，同步/异步, 计算耗时, 发送数据量, 返回数据量)
        ...
        "Download Book": {
            ...
            "path1": [
                ...
                ("Service Server.Service.BookService", "DAO Server.Mapper.BookMapper", "query(Book)", "Synchronous", 0.1, 10, 1000),
                ("DAO Server.Mapper.BookMapper", "SQL DataBase.DataComponent.DataBase", "query(String)", "Synchronous", 0.1, 10, 1000),
                ("Controller Server.Controller.BookController", "Service Server.Service.BookService", "readFile(String)", "Asynchronous", 0.1, 10, 1000),
                ("Controller Server.Controller.BookController", "Service Server.Service.BookService", "readPicture(String)", "Asynchronous", 0.1, 10, 1000)
            ]
        },
        "Print Book": {
            "prob": {
            ...
            "path0": [
                ...
                ("Service Server.Service.BookService", "Printer.BookPrinter.Printerervice", "printAll(Book)", "Asynchronous", 0.1, 10, 1000)
            ],
            "path1": [
                ("Actor", "Controller Server.Controller.BookController", "printBook(Book)", "Synchronous", 0.1, 10, 1000),
                ...
                ("Service Server.Service.BookService", "Printer.BookPrinter.Printerervice", "printPages(Book, int, int)", "Asynchronous", 0.1, 10, 1000)
            ]
        },
        "Read Book": {
            "prob": {
